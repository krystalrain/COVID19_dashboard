...
Unless otherwise cited informaiton for this project was suppported by class, lectuer, and book materials, or
documentation from a libraries page. 
...
def vaccineAttitudesChangedOverTime():
    ...
    count = 0
    for index in range(len(per)):
        #add a value to our dict temp_d
        append_value(temp_d, date[count], per[index])
        count += 1 
        if count == 4:
            count = 0
